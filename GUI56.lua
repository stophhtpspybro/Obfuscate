library = {flags={},items={}};
library.theme = {fontsize=15,titlesize=20,font=Enum.Font.Code,background="rbxassetid://5553946656",tilesize=50,cursor=false,cursorimg="https://t0.rbxcdn.com/42f66da98c40252ee151326a82aab51f",backgroundcolor=Color3.fromRGB(255, 255, 255),tabstextcolor=Color3.fromRGB(255, 255, 255),bordercolor=Color3.fromRGB(255, 255, 255),accentcolor=Color3.fromRGB(255, 255, 255),accentcolor2=Color3.fromRGB(255, 255, 255),outlinecolor=Color3.fromRGB(255, 255, 255),outlinecolor2=Color3.fromRGB(255, 255, 255),sectorcolor=Color3.fromRGB(255, 255, 255),toptextcolor=Color3.fromRGB(255, 255, 255),topheight=48,dpScrollBarThickness=10,topcolor=Color3.fromRGB(255, 255, 255),topcolor2=Color3.fromRGB(255, 255, 255),buttoncolor=Color3.fromRGB(255, 255, 255),buttoncolor2=Color3.fromRGB(255, 255, 255),itemscolor=Color3.fromRGB(255, 255, 255),itemscolor2=Color3.fromRGB(255, 255, 255)};
